...
//					ConcurrentTimedScheduler.class.getClassLoader());
//		}
...
//	}
	 ...
	 */
	public ConcurrentTimedScheduler(ScheduledExecutorService scheduledExecutor) {
...
//	 */
//	public ConcurrentTimedScheduler(Executor concurrentExecutor, ScheduledExecutorService scheduledExecutor) {
...
//				return new TimedReschedulingRunnable(task, trigger, this.clock, this.scheduledExecutor, errorHandler).schedule();
//			}
			ErrorHandler errorHandler = (this.errorHandler != null ? this.errorHandler : TaskUtils.getDefaultErrorHandler(true));
			return new TimedReschedulingRunnable(task, trigger, this.clock, this.scheduledExecutor, errorHandler).schedule();
		}
